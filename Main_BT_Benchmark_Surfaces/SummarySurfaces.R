...
Instances = c("BT1_2_0.031","BT2_2_0.031", "BT3_2_0.031", "BT4_2_0.031", "BT5_2_0.031", "BT6_2_0.031", "BT7_2_0.031", "BT8_2_0.031")
for( i in Instances)
{
	setEPS()
...
#	eafplot( list( 'AVSD-MOEA\\D'=vsdmoead,  'MOEA\\D-DE'=moead, 'NSGA-II'=nsgaii, 'NSGA-III'=nsgaiii, 'R2-EMOA'=r2emoa), percentiles=c(50), col=colors, lty = c("dashed", "dotdash", "dotted", "twodash", "longdash"), xlab="Objective 1", ylab="Objective 2", xlim=c(0, 1.3), ylim=c(0,1.3), main="UF5")
	eafplot( list( 'AVSD-MOEA\\D'=vsdmoead,  'MOEA\\D-DE'=moead, 'NSGA-II'=nsgaii, 'NSGA-III'=nsgaiii, 'R2-EMOA'=r2emoa), percentiles=c(50), col=colors, lty = c("dashed", "dotdash", "dotted", "twodash", "longdash"), xlab="Objective 1", ylab="Objective 2", xlim=c(0, 1.1), ylim=c(0,1.1), main="BT6")
